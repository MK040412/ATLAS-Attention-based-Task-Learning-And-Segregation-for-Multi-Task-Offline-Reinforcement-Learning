...
def main():
    ...
    print("🚀 Starting Ultimate Fixed Training...")
    ...
    if not sim_manager.initialize(args):
        print("❌ Failed to initialize simulation")
        return

    try:
        # 필요한 모듈들 import (시뮬레이션 초기화 후)
        ...
        for task_idx, task in enumerate(tasks):
            ...
            try:
                # 새 태스크를 위한 시뮬레이션 리셋
                if task_idx > 0:
                    sim_manager.reset_for_new_task()
